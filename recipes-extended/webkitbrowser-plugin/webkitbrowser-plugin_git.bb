...
EXTRA_OECMAKE += " \
    ...
    ${@bb.utils.contains('DISTRO_FEATURES', 'webkit_non_root_support', ' -DPLUGIN_WEBKITBROWSER_USER=${WEBKITBROWSER_USER} -DPLUGIN_WEBKITBROWSER_GROUP=${WEBKITBROWSER_GROUP} ', ' ', d)} \
"
