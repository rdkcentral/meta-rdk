...
EXTRA_OECMAKE += " \
    ...
    ${@bb.utils.contains('DISTRO_FEATURES', 'webkit_non_root_support', ' -DPLUGIN_HTMLAPP_NON_ROOT_USER=${HTMLAPP_NON_ROOT_USER} -DPLUGIN_HTMLAPP_NON_ROOT_GROUP=${HTMLAPP_NON_ROOT_GROUP} ', ' ', d)} \
"
