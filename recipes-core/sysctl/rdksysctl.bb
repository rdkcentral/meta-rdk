...
do_install() {
    ...
    install -m 0644 ${S}/98-sysctl-mw.conf ${D}${sysconfdir}/sysctl.d/98-sysctl-mw.conf
    sed -i -e "s|@RDK_VM_VFS_CACHE_PRESSURE@|${RDK_VM_VFS_CACHE_PRESSURE}|g" \
        ${D}${sysconfdir}/sysctl.d/98-sysctl-mw.conf
}
